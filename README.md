# genpark-agent-computer-interface-swe-patch-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Agent-Computer Interface SWE patch synthesizer & automated bug fixer (SWE-agent style)
